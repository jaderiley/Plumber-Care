...
const CONFIG = {
  ...
  business: {
    name:      "Plumber care",
    phone:     "+27 72 319 7942",
    whatsapp:  "+27 72 319 7942",
    address:   "84 8th linden Johannesburg, Linden, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Plumber care — Plumber in linden",
    description: "Plumber care provides professional plumber in Linden. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Plumber · Linden & surrounds",
    heroTitle:  "Burst pipe? Blocked drain? <em>We will fix it fast.</em>",
    heroLead:   "Plumber care provides fast, reliable plumbing services for homes and businesses across Linden and the surrounding areas. Emergency callouts welcome.",
    ...
    band: {
      ...
      alt:   "Plumber care team at work in Linden",
      text:  "Fast, reliable plumbing — emergency callouts welcome."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Linden. Serving the wider area.",
    areasLead:  "We cover Linden, Johannesburg, Randburg and the surrounding suburbs. Emergency callouts available throughout the area.",
